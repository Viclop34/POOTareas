...
//    metodos
    ...
    public String generarIdMedico(String apellidoMedico, String fechaNacimientoMedico){
        char unoApellido = apellidoMedico.charAt(0);
        char dosApellido = apellidoMedico.charAt(1);
        char ultimoFecha = fechaNacimientoMedico.charAt(fechaNacimientoMedico.length()-1);
