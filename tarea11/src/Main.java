                ...
                while(opcion != 9) {
                    ...
                    switch (opcion) {
                        ...
                        case 4:
                            ...
                            if (!validadorHospital.validarDispolnibilidadEnFechaConsulta(fechaConsulta, numeroConsultorio,hospital.listaConsultas)){
...
/*
                            if (!validadorHospital.validarDisponibilidadMedico(fechaConsulta, idDoctor, hospital.listaConsultas)){
                                System.out.println("Medico no disponible");
                                break;
                            }
                            */
