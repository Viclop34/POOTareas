...
public class Menu {
    ...
    private void mostrarMenuPaciente(Paciente paciente2){
        int opcion=0;
        while(opcion != 4){
    ...
    private void mostrarMenuMedico(Medico medico2){
        int opcion=0;
        while(opcion != 7){
            System.out.println("* Sistema Hospital *");
